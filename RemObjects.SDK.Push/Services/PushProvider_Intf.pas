...
type
  ...
  public 
    class method &Create(aMessage: RemObjects.SDK.IMessage; aClientChannel: RemObjects.SDK.IClientChannel): IWindowsPhonePushProviderService;
    class method &Create(aRemoteService: RemObjects.SDK.IRemoteService): IWindowsPhonePushProviderService;
    class method &Create(aUri: System.Uri): IWindowsPhonePushProviderService;
    class method &Create(aUrl: System.String): IWindowsPhonePushProviderService;
  end;
...
method WindowsPhonePushProviderService_Proxy.__GetInterfaceName: System.String;
begin
  exit('WindowsPhonePushProviderService');
end;

constructor WindowsPhonePushProviderService_Proxy(aMessage: RemObjects.SDK.IMessage; aClientChannel: RemObjects.SDK.IClientChannel);
begin
  inherited constructor(aMessage, aClientChannel);
end;

constructor WindowsPhonePushProviderService_Proxy(aMessage: RemObjects.SDK.IMessage; aClientChannel: RemObjects.SDK.IClientChannel; aOverrideInterfaceName: System.String);
begin
  inherited constructor(aMessage, aClientChannel, aOverrideInterfaceName);
end;

constructor WindowsPhonePushProviderService_Proxy(aRemoteService: RemObjects.SDK.IRemoteService);
begin
  inherited constructor(aRemoteService);
end;

constructor WindowsPhonePushProviderService_Proxy(aRemoteService: RemObjects.SDK.IRemoteService; aOverrideInterfaceName: System.String);
begin
  inherited constructor(aRemoteService, aOverrideInterfaceName);
end;

constructor WindowsPhonePushProviderService_Proxy(aUri: System.Uri);
begin
  inherited constructor(aUri);
end;

constructor WindowsPhonePushProviderService_Proxy(aUrl: System.String);
begin
  inherited constructor(aUrl);
end;
...
class method CoWindowsPhonePushProviderService.&Create(aMessage: RemObjects.SDK.IMessage; aClientChannel: RemObjects.SDK.IClientChannel): IWindowsPhonePushProviderService;
begin
  exit(new WindowsPhonePushProviderService_Proxy(aMessage, aClientChannel));
end;

class method CoWindowsPhonePushProviderService.&Create(aRemoteService: RemObjects.SDK.IRemoteService): IWindowsPhonePushProviderService;
begin
  exit(new WindowsPhonePushProviderService_Proxy(aRemoteService));
end;

class method CoWindowsPhonePushProviderService.&Create(aUri: System.Uri): IWindowsPhonePushProviderService;
begin
  exit(new WindowsPhonePushProviderService_Proxy(aUri));
end;

class method CoWindowsPhonePushProviderService.&Create(aUrl: System.String): IWindowsPhonePushProviderService;
begin
  exit(new WindowsPhonePushProviderService_Proxy(aUrl));
end;
...
method WindowsPhonePushProviderService_AsyncProxy.__GetInterfaceName: System.String;
begin
  exit('WindowsPhonePushProviderService');
end;

constructor WindowsPhonePushProviderService_AsyncProxy(aMessage: RemObjects.SDK.IMessage; aClientChannel: RemObjects.SDK.IClientChannel);
begin
  inherited constructor(aMessage, aClientChannel);
end;

constructor WindowsPhonePushProviderService_AsyncProxy(aMessage: RemObjects.SDK.IMessage; aClientChannel: RemObjects.SDK.IClientChannel; aOverrideInterfaceName: System.String);
begin
  inherited constructor(aMessage, aClientChannel, aOverrideInterfaceName);
end;

constructor WindowsPhonePushProviderService_AsyncProxy(aRemoteService: RemObjects.SDK.IRemoteService);
begin
  inherited constructor(aRemoteService);
end;

constructor WindowsPhonePushProviderService_AsyncProxy(aRemoteService: RemObjects.SDK.IRemoteService; aOverrideInterfaceName: System.String);
begin
  inherited constructor(aRemoteService, aOverrideInterfaceName);
end;

constructor WindowsPhonePushProviderService_AsyncProxy(aUri: System.Uri);
begin
  inherited constructor(aUri);
end;

constructor WindowsPhonePushProviderService_AsyncProxy(aUrl: System.String);
begin
  inherited constructor(aUrl);
end;
